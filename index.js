...
const compose = __webpack_require__(19)
...
var debug = __webpack_require__(8)('koa-send');
var resolvePath = __webpack_require__(74);
...
const debug = __webpack_require__(8)('koa-static');
const resolve = __webpack_require__(0).resolve;
const assert = __webpack_require__(2);
const send = __webpack_require__(13);
...
const isGeneratorFunction = __webpack_require__(56);
...
const compose = __webpack_require__(19);
const isJSON = __webpack_require__(20);
const context = __webpack_require__(58);
const request = __webpack_require__(59);
const statuses = __webpack_require__(1);
const Cookies = __webpack_require__(34);
const accepts = __webpack_require__(28);
const Emitter = __webpack_require__(23);
const assert = __webpack_require__(2);
const Stream = __webpack_require__(4);
const http = __webpack_require__(6);
const only = __webpack_require__(11);
...
module.exports = __webpack_require__(30)(global, loadImplementation);
...
var Keygrip = __webpack_require__(57)
...
if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
  process.on('exit', function() {
    debug(queue)
    __webpack_require__(2).equal(queue.length, 0)
  })
}
...
var eql = __webpack_require__(37);
...
const createError = __webpack_require__(54);
const httpAssert = __webpack_require__(51);
const delegate = __webpack_require__(40);
const statuses = __webpack_require__(1);
...
const contentDisposition = __webpack_require__(32);
const ensureErrorHandler = __webpack_require__(46);
const getType = __webpack_require__(10).contentType;
const onFinish = __webpack_require__(21);
const isJSON = __webpack_require__(20);
const escape = __webpack_require__(47);
const typeis = __webpack_require__(22).is;
const statuses = __webpack_require__(1);
...
__webpack_require__(79).withCallback(fs, exports, api)
...
var pathIsAbsolute = __webpack_require__(73)
...
var thenify = __webpack_require__(80)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_koa__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_koa_send__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_koa_static__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_koa_convert__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_koa_convert___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_koa_convert__);
...
app.use = x => appUse.call(app, __WEBPACK_IMPORTED_MODULE_4_koa_convert___default()(x)); // convert old middleware

app.use(__WEBPACK_IMPORTED_MODULE_3_koa_static___default()('./dist'));

app.use(async function (ctx, next) {
  return __WEBPACK_IMPORTED_MODULE_2_koa_send___default()(ctx, '/index.html')
    .then(() => next());
});

const httpServer = __WEBPACK_IMPORTED_MODULE_1_http___default.a.createServer(app.callback());
